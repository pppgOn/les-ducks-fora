...
import levelJson from "../../public/json/levelIndustry.json"
...
const LevelHouse = () => {
    ...
    var gameModel = new GameModel('../public/images/mapIndustry.png', 0, 600, '../public/images/trigger.png', actions, 3);
